<template>
  <section class="section terms">
    <div class="container">
      <h2 class="h2 section-title">Terms and Conditions</h2>

      <p>Last updated: [May 28, 2023]</p>
      <h3>AGREEMENT TO OUR LEGAL TERMS</h3>

      <p>
        We are X-Element LLC ("Company," "we," "us," "our"), a company
        registered in __________ at __________, Junction City, KS, __________.
      </p>

      <p>
        We operate the website
        <a href="https://teamxelement.com/"
          ><strong>https://teamxelement.com/</strong></a
        >
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity ("you"), and X-Element
      ...
      <p>
        ...
        <a href="mailto:officialxelement@gmail.com" target="_blank"
      ...
      <ul>
        ...
        <li>
          ...
          have the necessary rights and licenses to submit such Submissions and
      ...
      <p>
        ...
        you have received parental permission to use the Services; (3) you will
