...
const routes = [
  ...
  { path: "/bios/aaron", name: "Aaron", component: Aaron },
  { path: "/bios/spoon", name: "Spoon", component: Spoon },
  { path: "/bios/future", name: "Future", component: Future },
